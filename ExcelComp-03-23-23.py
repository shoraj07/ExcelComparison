...
df1 = pd.read_csv(
    r'D:\BI- Mark\CMPLBI_BV DataValidation\03-17-23\BV_CMPL_ETHICS_PHASES_VW.csv')  # reading sheet 1
df2 = pd.read_excel(
    r'D:\BI- Mark\CMPLBI_BV DataValidation\03-17-23\CMPL_ETHICS_PHASES_VW_UPD.xlsx')  # reading sheet 2
df3 = pd.read_excel(
    r'D:\BI- Mark\CMPLBI_BV DataValidation\03-17-23\Mapping file.xlsx')  # reading heading modeling file
...
colName_dict = dataframe_to_dict(df3, 'SF Column', 'Oracle Column') # here 'Snowflake' and 'Oracle' is the heading name in the
