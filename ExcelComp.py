...
df1 = pd.read_excel(
    r'D:\BI- Mark\CMPLBI_BV DataValidation\02-23-23\Oracle.xlsx')  # reading sheet 1
df2 = pd.read_excel(
    r'D:\BI- Mark\CMPLBI_BV DataValidation\02-23-23\Snowflake.xlsx')  # reading sheet 2
df3 = pd.read_excel(
    r'D:\BI- Mark\CMPLBI_BV DataValidation\02-23-23\Mapping.xlsx')  # reading heading modeling file
